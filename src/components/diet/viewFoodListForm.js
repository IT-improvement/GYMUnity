...
import { Box, Button, Card, CardBody, Flex, Grid, Heading, IconButton, Image, Text } from '@chakra-ui/react';
...
const ViewFoodListForm = ({ searchQuery, isDescOrder, isTotalSearch }) => {
    ...
    const getCategoryName = (categoryIndex) => {
        const category = foodCategoryList.find((cat) => cat.foodCategoryIndex === categoryIndex);
        return category ? category.categoryName : 'Unknown Category';
    };

    const getCategoryImageUrl = (categoryIndex) => {
        const category = foodCategoryList.find((cat) => cat.foodCategoryIndex === categoryIndex);
        return category ? category.categoryImageUrl : 'Unknown CategoryImageUrl';
    };
    ...
    return (
        <Flex direction="column" p="10px" bgColor="gray.300" gap="10px" borderRadius="10px">
            ...
            <Box>
                ...
                {isLoggedIn && (
                    <Flex justify="right">
                        <Button colorScheme="blue" onClick={() => navigate('/diet/createFood')}>
                            Food 생성
                        </Button>
                    </Flex>
                )}
                                        ...
                                        <Grid templateColumns="repeat(2, 1fr)" p="10px" gap="10px" borderRadius="10px">
                                            ...
                                            >
                                                <Flex direction="column" gap="10px" align="center">
                                                    {
                                                        <Image
                                                            src={getCategoryImageUrl(food.foodCategoryIndex)}
                                                            alt={food.foodName}
                                                            boxSize="50px"
                                                            objectFit="cover"
                                                        />
                                            ...
                                            <Flex direction="column" gap="10px">
                                                ...
                                                <Text>음식 종류: {getCategoryName(food.foodCategoryIndex)}</Text>
            ...
            <Box>
                ...
                {isLoggedIn && (
                    <Flex justify="right">
                        <Button colorScheme="blue" onClick={() => navigate('/diet/createFoodCategory')}>
                            Food Category 생성
                        </Button>
                    </Flex>
                )}
                    ...
                    <Flex direction="column" gap="10px">
                        ...
                        >
                            {foodCategoryList.map((category) => (
                                <Card key={category.categoryIndex} _hover={{ backgroundColor: 'gray.500' }}>
                                    <CardBody>
                                        <Grid templateColumns="repeat(2, 1fr)" p="10px" gap="10px" borderRadius="10px">
                                            <Box
                                                p="10px"
                                            ...
                                            <Flex direction="column" gap="10px">
                                                ...
                                                <Flex justify="right">
                                                    ...
                                                    <IconButton
                                                        ...
                                                        icon={<DeleteIcon />}
                                                        onClick={() => handleDeleteCategory(category.foodCategoryIndex)}
                                                    />
                                                </Flex>
                                            </Flex>
                                        </Grid>
