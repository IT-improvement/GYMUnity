            ...
            <Box>
                ...
                {foodList.length > 0 ? (
                    <Flex direction="column" gap="10px">
                        ...
                        >
                            {foodList.map((food) => (
                                <Card key={food.foodIndex} _hover={{ backgroundColor: 'gray.500' }}>
                                    <CardBody>
                                        <Grid templateColumns="repeat(2, 1fr)" p="10px" gap="10px" borderRadius="10px">
                                            ...
                                            <Flex direction="column" gap="10px">
                                                ...
                                                <Text>음식 종류: {food.foodCategoryName}</Text>
                                    ...
                                    <CardBody>
                                        <Grid templateColumns="repeat(2, 1fr)" p="10px" gap="10px" borderRadius="10px">
                                            ...
                                            <Flex direction="column" gap="10px">
                                                ...
                                                <Text>설명: {category.description}</Text>
                                                <Text>작성일: {category.createDate}</Text>
                                                {category.modDate && <Text>수정일: {category.modDate}</Text>}
                                                <Flex justify="right">
                                                    <IconButton
                                                        aria-label="Edit category"
                                                        icon={<EditIcon />}
                                                        onClick={() =>
                                                            navigate(`/diet/editFoodCategory/${category.categoryIndex}`)
                                                        }
                                                        mr={2}
                                                    />
                                                    <IconButton
