								...
								<FormControl id="id" marginTop="20px" marginBottom="10px">
									<Flex align="center" margin="auto">
										...
										<Input
											type="text"
											value={id}
                    							<Flex direction="column" gap="50px" justify="center" align="center"></Flex>
											<FormControl>
												<Flex justify="center">
													<FormLabel width="100px" fontWeight="bold">아이디</FormLabel>
											...
											<Flex justify="center" marginBottom="15px">
												...
												<Flex justify="center" gap="10px">
													...
													<Button as="a" width="150px" height="50px" colorScheme="custom" backgroundColor="#96B6C5" href="./join"></Button>
